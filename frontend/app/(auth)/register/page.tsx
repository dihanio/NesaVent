...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.role === 'mitra') {
        registerData.role = 'mitra';
        registerData.organisasi = data.organisasi;
      }
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <select
              id="role"
              name="role"
              className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              value={formData.role}
              onChange={handleChange}
            >
              <option value="user">Pengguna Biasa</option>
              <option value="mitra">Mitra Organisasi</option>
            </select>
          </div>
          ...
          {formData.role === 'mitra' && (
            <div>
              ...
              <input
                ...
                name="organisasi"
                type="text"
                required={formData.role === 'mitra'}
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Nama organisasi/perusahaan Anda"
